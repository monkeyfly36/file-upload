<template>
  <div class="login-container">
    <el-form class="login-form" ref="registerForm" label-width="100px" :model="form" :rules="rules">
...
export default {
  ...
  data() {
    return {
      form: {
        email: "15021071513@163.com",
        nickname: "monkeyfly36",
        passwd: "123456",
        repasswd: "123456",
        captcha: ""
      },
      rules: {
        ...
        passwd: [
          {required: true, patten:/^[w_-]{6~12}$/g, message: '请输入6～12位密码'},
        ],
        repasswd: [
